...
public class GreenFilterBlossom extends Filter {
    private int program;
    private int texture2Id;

    public GreenFilterBlossom(Context context) {
        super(context);
        ...
        texture2Id = LSYSUtility.loadTexture(context, R.raw.tex_blossom, new int[2]);
    }
