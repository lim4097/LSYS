...
public class GreenFilterDesert extends Filter {
    private int program;
    private int texture2Id;

    public GreenFilterDesert(Context context) {
        super(context);
        ...
        texture2Id = LSYSUtility.loadTexture(context, R.raw.tex_desert, new int[2]);
    }
