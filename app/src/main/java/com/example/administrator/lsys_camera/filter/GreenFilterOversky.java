...
public class GreenFilterOversky extends Filter {
    private int program;
    private int texture2Id;

    public GreenFilterOversky(Context context) {
        super(context);
        ...
        texture2Id = LSYSUtility.loadTexture(context, R.raw.tex_oversky, new int[2]);
    }
