...
public class MappingFilterSmoke extends Filter {
    private int program;
    private int texture2Id;

    public MappingFilterSmoke(Context context) {
        super(context);
        ...
        texture2Id = LSYSUtility.loadTexture(context, R.raw.texmap_smoke, new int[2]);
    }
