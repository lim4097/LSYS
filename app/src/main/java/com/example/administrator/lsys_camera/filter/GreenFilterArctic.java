...
public class GreenFilterArctic extends Filter {
    private int program;
    private int texture2Id;

    public GreenFilterArctic(Context context) {
        super(context);
        ...
        texture2Id = LSYSUtility.loadTexture(context, R.raw.tex_arctic, new int[2]);
    }
