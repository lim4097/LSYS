...
public class MiniSticker extends AbstractSticker {
    ...
    public MiniSticker(Context context, FloatBuffer vertexBuf, FloatBuffer roatedTextureCoordBuf, int type, float percent)
    {
        textTexId = new int[1];
