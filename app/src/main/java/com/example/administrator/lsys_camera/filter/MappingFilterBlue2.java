...
public class MappingFilterBlue2 extends Filter {
    private int program;
    private int texture2Id;

    public MappingFilterBlue2(Context context) {
        super(context);
        ...
        texture2Id = LSYSUtility.loadTexture(context, R.raw.texmap_blue2, new int[2]);
    }
