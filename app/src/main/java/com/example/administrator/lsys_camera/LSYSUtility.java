...
public class LSYSUtility {
    ...
    public static Thread Save(Context context, TextureView textureView, Object saveObject)
    {
      //  Thread svaeThread = new Thread(new ImageSaver(context,textureView, saveObject));
        Thread svaeThread = new Thread(new JPGSaver(context,textureView, saveObject));
        svaeThread.start();
        return svaeThread;
    }

    // GIF 저장
    public static Thread Save(Context context, ArrayList<Bitmap> bitmapList, int goalCount, Object saveObject, int gifText)
    {
       // Thread svaeThread = new Thread(new ImageSaver(context,bitmapList, goalCount, saveObject ,gifText));
        Thread svaeThread = new Thread(new GIFSaver(context,bitmapList, goalCount, saveObject ,gifText));
        svaeThread.start();
        return svaeThread;
    }
    ...
    {
        Thread svaeThread = new Thread(new JPGSaver(context, textureView, bitmap, saveObject));
        svaeThread.start();
        return svaeThread;
    }
}
