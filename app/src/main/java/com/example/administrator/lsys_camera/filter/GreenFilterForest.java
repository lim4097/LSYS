...
public class GreenFilterForest extends Filter {
    private int program;
    private int texture2Id;

    public GreenFilterForest(Context context) {
        super(context);
        ...
        texture2Id = LSYSUtility.loadTexture(context, R.raw.tex_forest, new int[2]);
    }
