...
public  class ImageSaver implements Runnable {
    ...
    private ImageView btChange, btFlash, btTimer, btCapture, collageButton, galleryButton;
    ...
    /*
    public ImageSaver(Context context, byte[] gif) {
        this.context = context;
        this.gif = gif;
        this.type = "gif";
    }*/

    public ImageSaver(Context context, ArrayList<Bitmap> bitmapList, int gifGoalCount, Object saveObject ,int gifTextId) {
        this.context = context;
                ...
                mHandler.post(new Runnable() {
                    ...
                    public void run() {
                        ...
                        else // gif일때
                        {
                            ...
                            /////////no  gifText.setBackgroundDrawable(null);
                       ...
                       // btText = (ImageView) activity.findViewById(R.id.id_icon_text);
