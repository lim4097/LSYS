...
public class MappingFilterLight extends Filter {
    private int program;
    private int texture2Id;

    public MappingFilterLight(Context context) {
        super(context);
        ...
        texture2Id = LSYSUtility.loadTexture(context, R.raw.texmap_lighting, new int[2]);
    }
